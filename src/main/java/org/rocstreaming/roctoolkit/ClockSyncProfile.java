...
public enum ClockSyncProfile {
     ...
     * Default profile.
     * <p>
     * When {@link ClockSyncBackend#NIQ} is used, selects
     * {@link ClockSyncProfile#RESPONSIVE} if target latency is low, and
     * {@link ClockSyncProfile#GRADUAL} if target latency is high.
     */
    DEFAULT(0),
     ...
     * <li>does not work well with {@link ClockSyncBackend#NIQ} if network
     * jitter is high</li>
     * </ul>
     */
    RESPONSIVE(1),
