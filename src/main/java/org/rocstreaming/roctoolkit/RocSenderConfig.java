...
public class RocSenderConfig {
     ...
     * local frames created by user and passed to sender. Should be set (zero
     * value is invalid).
     */
     ...
     * {@link frameEncoding}. This automatic selection matches only encodings
     ...
     * {@link RocContext#registerEncoding()} to register custom encoding, set
     * {@link packetEncoding} to registered identifier. If you use signaling
     ...
     * flushed or closed. Larger number reduces packet overhead but also
     * increases latency. If zero, default value is used.
     */
     ...
     * FEC encoding to use.
     * <p>
     * If non-zero, the sender employs a FEC encoding to generate redundant
     * packets which may be used on receiver to restore lost packets. This
     * requires both sender and receiver to use two separate source and repair
     * endpoints.
     */
     ...
     * {@link fecBlockSourcePackets} and M is {@link fecBlockRepairPackets}.
     * <p>
     ...
     * Clock source to use.
     * <p>
     * Defines whether write operation will be blocking or non-blocking. If
     * zero, default value is used ( {@link ClockSource#EXTERNAL} ).
     */
     ...
     * <p>
     * If non-zero, the sender employs resampler if the frame sample rate
