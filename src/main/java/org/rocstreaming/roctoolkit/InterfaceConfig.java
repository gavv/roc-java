...
public class InterfaceConfig {
     ...
     * <p>
     * Setting it to 0.0.0.0 (for IPv4) or to :: (for IPv6) gives the same
     ...
     * network interface on which to join the multicast group. If not present,
     * no multicast group is joined.
     * <p>
     ...
     * group manually using OS-specific API.
     * <p>
