...
public class MediaEncoding {
     ...
     * <p>
     * If {@code channels} is {@link ChannelLayout#MULTITRACK}, defines number
     * of channels (which represent independent "tracks"). For other channel
     * layouts should be zero.
     * <p>
