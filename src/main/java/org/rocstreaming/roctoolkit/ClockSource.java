...
public enum ClockSource {
     ...
     * <p>
     * Current default is {@link ClockSource#EXTERNAL}.
     */
    DEFAULT(0),
     ...
     * destination (to where you write them after obtaining from sender) is
     * active and has its own clock, e.g. it is a sound card.
     */
    EXTERNAL(1),
     ...
     * configured sample rate, based on a CPU timer.
     * <p>
     * Use when samples source (from where you read them to pass to receiver) or
     * destination (to where you write them after obtaining from sender) is
     * passive and does now have clock, e.g. it is a file on disk.
     */
    INTERNAL(2),
    ;
