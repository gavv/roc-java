...
public enum ResamplerBackend {
     ...
     * {@link LatencyTunerProfile#RESPONSIVE}, or when SpeexDSP is disabled.
     * <p>
     ...
     * <p>
     * This backend has higher CPU usage, especially on high resampling quality
     * and on CPUs with small L3 caches.
     * <p>
     * The implementation is based on bandlimited interpolation algorithm.
     * <p>
     * This backend is always available.
     * <p>
     * Recommended for {@link LatencyTunerProfile#RESPONSIVE} and on good CPUs.
     */
    BUILTIN(1),
     ...
     * CPUs.
     * <p>
     * This backend controls clock speed with lower precision, and is not so
     * good when latency or synchronization error should be very low.
     * <p>
     * This backend is available only when SpeexDSP was enabled at build time.
     * <p>
     * Recommended for {@link LatencyTunerProfile#GRADUAL} and on cheap CPUs.
     */
    SPEEX(2),

    /**
     * Fast medium-quality and medium-precision resampler combining SpeexDSP
     * with decimation.
     * <p>
     * This backend uses SpeexDSP for converting between base rates (e.g. 44100
     * vs 48000) and decimation/expansion (dropping or duplicating samples) for
     ...
     * <p>
     * When frame and packet rates are different, usage of this backend compared
     * to {@link ResamplerBackend#SPEEX} allows to sacrify some quality, but
     * somewhat improve scaling precision and CPU usage in return.
     * <p>
     * This backend is available only when SpeexDSP was enabled at build time.
     * <p>
